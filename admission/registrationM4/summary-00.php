...
if ($file01_extension != "") {
    $new_file01_name = 'm4_img_' . $_POST['reg_card_id'] . "." . $file01_extension;
...
if ($file02_extension != "") {
    $new_file02_name = 'm4_file_' . $_POST['reg_card_id'] . "." . $file02_extension;
...
if ($file03_extension != "") {
    $new_file03_name = 'm4_file_' . $_POST['reg_card_id'] . "." . $file03_extension;
...
if ($file04_extension != "") {
    $new_file04_name = 'm4_file_' . $_POST['reg_card_id'] . "." . $file04_extension;
...
if ($file05_extension != "") {
    $new_file05_name = 'm4_file_' . $_POST['reg_card_id'] . "." . $file05_extension;
...
if ($file06_extension != "") {
    $new_file06_name = 'm4_file_' . $_POST['reg_card_id'] . "." . $file06_extension;
...
if ($file05_extension != "") {
    ...
    if ($status_file5 == false) {
        echo "ไม่สามารถบันทึก สำเนาหนังสือรับรองกำลังศึกษาอยู่ชั้น ม.3 หรือ สำเนา ปพ.1 ";
        //exit();
    }
}
...
'" . $prov_3[0] . "',
'" . $_POST['reg_plan1_id'] . "',
'" . $_POST['reg_plan1_name'] . "',
'" . $_POST['reg_plan2_id'] . "',
'" . $_POST['reg_plan2_name'] . "',
'" . $new_file01_name . "',
'" . $status_file1 . "',
'" . $new_file02_name . "',
'" . $status_file2 . "',
...
//$condb->commit();
    ...
    ?>
            ...
            <form action="../bill/index.php" method="post">
                ...
                <input type="hidden" name="send_reg_class" value="m4">
