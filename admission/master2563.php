    ...
    <br><br><br> -->
      ...
      <div class="card-deck">
        ...
        <div class="card border-primary">
          <div class="card-body">
            ...
            <p class="text-danger"><i class="fas fa-exclamation"></i> หลังจากชำระค่าสมัครเรียบร้อยแล้วให้รอการเปลี่ยนแปลงสถานะ 1-2 วัน </p>
          </div>
        </div>
        <div class="card border-primary">
          <div class="card-body">
      ...
      <div class="text-center">
        <div class="btn-group-vertical">
          ...
          <a class="btn btn-success" href="registrationM1/find_card.php" role="button">พิมพ์บัตรประจำตัวผู้สอบ (ตั้งแต่วันที่ 20 พฤษภาคม 2563)</a>
        </div>
        ...
        <div class="btn-group-vertical">
          ...
          <a class="btn btn-warning" href="registrationM4/find_card.php" role="button">พิมพ์บัตรประจำตัวผู้สอบ (ตั้งแต่วันที่ 20 พฤษภาคม 2563)</a>
        </div>
      </div> <!-- <div class="text-center"> -->
      ...
      <hr>
      <h3><i class="fas fa-list-alt"></i> สรุปจำนวนผู้สมัครเข้าเรียน </h3>
      ...
      <h5 class=" alert  text-center " role="alert">ระดับชั้นมัธยมศึกษาปีที่ 1</h5>
        <table class="table table-striped">
              <thead>
                <tr class="">
                  <th scope="col"></th>
                  <th scope="col">ในเขตพื้นที่บริการ <i class="fas fa-user"></i></th>
                  <th scope="col">ทั่วไป <i class="fas fa-user"></i></th>
                  <th scope="col">สมัครรวม<i class="fas fa-user"></i></th>
                </tr>
              </thead>
              <tbody>
                <tr >
