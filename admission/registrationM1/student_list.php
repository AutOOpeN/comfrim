...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-10 text-left">
        <h4 style="color:#043c96;text-shadow: 2px 2px 4px #000000;"><?php echo $txt["HEADDERM1"] ?></h4>
        <hr />
...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM m1 ORDER BY id ASC");
    $stmt->execute();
    ...
    while ($row = $stmt->fetch()) {
        ...
        switch ($row['area_name']) {
            case "รอการตรวจสอบ":
                $str_area = "รอการตรวจสอบ";
                break;
            case "ในเขตพื้นที่บริการ":
                $str_area = "<font color= 'blue'>ในเขตพื้นที่บริการ </font>";
                break;
            case "ทัวไป":
                $str_area = "<font color= 'purple'>ทั่วไป</font>";
                break;
        }
