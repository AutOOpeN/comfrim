...
$conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    ...
    $str_sql = "SELECT * FROM ex_m1 WHERE ref1 = '" . $ref1 . "'";
...
<table>
    <tr>
        ...
        <td width = "500" colspan="2" style="text-align: right;"><h2>เลขที่นั่งสอบ: <u> $exam_id </u><br /> ห้องสอบที่ : <u> $exam_room </u></h2></td>
    </tr>
    <tr>
        <td width = "500" colspan="2"  style="text-align: center;"><h3>บัตรประจำตัวผู้เข้าสอบ ประเภทห้องเรียนทั่วไป โรงเรียนสตรีภูเก็ต</h3></td>
    </tr>
    <tr>
        <td width = "500" colspan="2"  style="text-align: center;"><h3>ชั้นมัธยมศึกษาปีที่ 1 ปีการศึกษา 2565 (สอบวันที่ 26 มีนาคม 2565)</h3></td>
    </tr>
</table>
    ...
    <tbody>
        <tr>
            ...
            <td width="450" >
                ...
                <p style="font-size: 18px;">ประเภท:<u> $area_name </u></p>
            </td>
        </tr>
    </tbody>
</table>
