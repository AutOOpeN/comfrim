...
?>
        ...
        <img src="../../spkimg/head1.gif" class ="img-fluid pull-center">
            <div class="container">
                ...
                <hr>
                <h3  style="color:#102c4c;text-shadow: 2px 2px 4px #000000;"><?php echo $txt['SYSTEMTITLEM1']; ?></h3>
                <hr>
...
<!--                     <div class="custom-control custom-radio mb-3">
                        ...
                        <div class="col-md4 mb-3">
                            ...
                            <label for="reg_plan1">เฉพาะนักเรียนที่ต้องการ สมัครความสามารถพิเศษ: </label>
                            <select id="reg_plan1" class="custom-select" onchange="setValue(this,'reg_plan_name','reg_plan_id')" disabled>
                                <option value="">เลือกประเภทที่ต้องการ</option>
                                <option value="1">ดนตรีไทย</option>
                                <option value="2">วาดภาพ</option>
                                <option value="3">กรีฑา (วิ่ง)</option>
                                <option value="4">แกะสลัก</option>
                                <option value="5">ว่ายน้ำ</option>
                                <option value="6">ปิงปอง</option>
                                <option value="7">วงโยธวาทิต (เครื่องเป่าลมไม้, ทองเหลือง หรือ เครื่องตี)</option>
                            </select>
                            <input type="hidden" name="reg_plan_name" id="reg_plan_name">
                            <input type="hidden" name="reg_plan_id" id="reg_plan_id">
                            <div class="alert alert-warning text-center" role="alert">
                               หลักฐานความสามารถพิเศษ (เกียรติบัตรหรือหนังสือรับรองจากผู้บริหารสถานศึกษา) <br>ยื่นต่อเจ้าหน้าที่ในวันสอบคัดเลือก (ปฏิบัติ) วันที่ 25 มีนาคม พ.ศ. 2562 (ห้อง To be nuber one เวลา 08:00 น.)
                            </div>
                </fieldset>
                ...
                <fieldset class="myfieldset">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="customFile3">สำเนาทะเบียนบ้านหน้าแรกและ หน้าที่มีชื่อผู้สมัคร พร้อมเซ็นรับรองสำเนาถูกต้อง <u>ไฟล์ PDF เท่านั้น</u>   </label>
                    </div>
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" name="file4" id="customFile4" accept="application/pdf" required>
                        <label class="custom-file-label" for="customFile4">สำเนาหนังสือรับรองกำลังศึกษาอยู่ชั้น ป.6 หรือ สำเนา ปพ.1 พร้อมผู้สมัครเซ็นรับรองสำเนาถูกต้อง <u>ไฟล์ PDF เท่านั้น</u> หน้าที่ 1   </label>
                    </div>
                    <div class="custom-file">
