...
<body>
    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data" action="summary-00.php" class="needs-validation" novalidate onsubmit="if(document.getElementById('agree').checked) { return true; } else { alert('กรุณาอ่านและยอมรับข้อตกลง ก่อนสมัคร'); return false; }">
            ...
            <!-- <fieldset class="myfieldset">
                <legend class="myfieldset">สมัครความสามารถพิเศษ </legend>

                <div class="col-md4 mb-3">

                    <label for="reg_plan1">*** เฉพาะนักเรียนที่ต้องการ สมัครความสามารถพิเศษ: </label>
                    <select id="reg_plan1" class="custom-select" onchange="setValue(this,'reg_plan_name','reg_plan_id')">
                    ...
                    <div class="alert alert-warning text-center" role="alert">
                        หลักฐานความสามารถพิเศษ (เกียรติบัตรหรือหนังสือรับรองจากผู้บริหารสถานศึกษา) <br>ยื่นต่อเจ้าหน้าที่ในวันสอบคัดเลือก (ปฏิบัติ)
                    </div>
            </fieldset> -->
            ...
            <fieldset class="myfieldset">
                ...
                <!--
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" name="file2" id="customFile2" accept="application/pdf" >
            ...
            <fieldset class="myfieldset">
                ...
                <div class="text-center">
                    ...
                    <input type="checkbox" name="checkbox" value="check" id="agree" class="text-success" required /> ฉันได้อ่านและยอมรับข้อตกลงการสมัคร</a>
                </div>
