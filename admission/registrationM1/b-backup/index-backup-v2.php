    ...
    <body>
        ...
        <img src="../../spkimg/head1.gif" class ="img-fluid pull-center">
            <div class="container">
                ...
                <hr>
                <p class="lead text-muted">ชั้นมัธยมศึกษาปีที่ ๑ ปีการศึกษา ๒๕๖๒</p>
                ...
                <fieldset class="myfieldset">
                    ...
                    -->
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="reg_tel" size="12" class="form-control" onkeyup="autoTab(this)"  onkeypress="return Numbers(event)" required>
                        </div>
                    </div>
                ...
                <fieldset class="myfieldset">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="father_tel" size="35" class="form-control"  onkeyup="autoTab(this)"  onkeypress="return Numbers(event)" required>
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset class="myfieldset">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="mother_tel" size="35" class="form-control"  onkeyup="autoTab(this)"  onkeypress="return Numbers(event)" required>
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset class="myfieldset">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="parent_tel" size="35"  class="form-control"  onkeyup="autoTab(this)"  onkeypress="return Numbers(event)" required>
                        </div>
                    </div>
                </fieldset>

                <fieldset class="myfieldset">
                    <legend class="myfieldset">กำลังศึกษาชั้น ป.๖ หรือจบ ป.๖ </legend>
                        <div class="form-group">
...
<div class="alert alert-warning text-center" role="alert">
  ** O-NET สามารถ upload ได้หลังจากวันที่ ๒๕ มีนาคม ๒๕๖๒
</div>
