...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-10 text-left">
      ...
      <ul class="fa-ul">
        <li><span class="fa-li" ><i class="fas fa-bullhorn"></i></span> เรื่อง การรับนักเรียนเข้าเรียนชั้นมัธยมศึกษาปีที่ 1 ประเภทห้องเรียนปกติ ปีการศึกษา 2562 <a href="http://www.satreephuket.ac.th/academic/ent_62/pracasrub_normal_m1_62.pdf" target="_bank">[อ่านประกาศ] </a>
        <br> <a href="http://www.satreephuket.ac.th/academic/ent_62/pracas_rubric_spe_skill2562.pdf" target="_bank">[เกณฑ์การคัดเลือกนักเรียนความสามารถพิเศษ รับสมัคร 22-23 มีนาคม 2562]</a></li>
        <li><span class="fa-li" ><i class="fas fa-bullhorn"></i></span> เรื่อง การรับนักเรียนเข้าเรียนชั้นมัธยมศึกษาปีที่ 4 ประเภทห้องเรียนปกติ ปีการศึกษา 2562 <a href="http://www.satreephuket.ac.th/academic/ent_62/pracasrub_normal_m4_62.pdf" target="_bank">[อ่านประกาศ]</a></li>
      </ul>
      <hr>
      ...
      <div class="card-deck">
        <div class="card border-primary">
          <div class="card-body">
            <h5 class="card-title">1. ตรวจสอบรายละเอียดผู้สมัคร</h5>
            <p>ตรวจสอบรายละเอียดของผู้สมัคร และไฟล์สำเนาเอกสารการสมัคร พร้อมรับรองสำเนาถูกต้องทุกหน้า ก่อนการ Upload</p>
          </div>
        </div>
        <div class="card border-primary">
          <div class="card-body">
            <h5 class="card-title"> 2. กรอกใบสมัคร</h5>
            <p>กรอกใบสมัครจากแบบฟอร์มออนไลน์</p>
            <br>
          </div>
        </div>
        <div class="card border-primary">
          <div class="card-body">
            <h5 class="card-title">3. พิมพ์แบบฟอร์มชำระเงิน </h5>
            <p>พิมพ์แบบฟอร์มชำระเงิน นำไปชำระได้ที่เคาน์เตอร์ธนาคารกรุงไทยจนถึงวันที่ 27 มีนาคม 2562 เท่านั้น</p>
          </div>
        </div>
        <div class="card border-primary">
          <div class="card-body">
            <h5 class="card-title"> 4. ตรวจสอบรายชื่อผู้มีสิทธิ์สอบ</h5>
            <p>ประกาศรายชื่อผู้มีสิทธิ์สอบและสถานที่สอบในวันที่ 29 มีนาคม 2562</p>
            <br>
          </div>
        </div>
      ...
      <div class="text-center">
        <div class="btn-group-vertical">
          ...
          <a class="btn btn-success" href="O-NET" role="button">บันทึกคะแนน O-NET สำหรับผู้ที่สมัครก่อนวันที่ 25 มีนาคม 2562</a>
        ...
        <div class="btn-group-vertical">
          ...
          <a class="btn btn-warning" href="O-NET" role="button">บันทึกคะแนน O-NET สำหรับผู้ที่สมัครก่อนวันที่ 26 มีนาคม 2562</a>
