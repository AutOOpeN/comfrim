            ...
            <form  action="" method="post" enctype="multipart/form-data">
                ...
                <fieldset class="myfieldset">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="file3">เลือกสำเนาหนังสือรับรองกำลังศึกษาอยู่ หรือ สำเนา ปพ.1 หน้าที่ 1</label>                 
                    </div>
        ...
        <?php
            ...
            if ( isset ($_FILES['file3'])){
                ...
                if ($file01_extension != "") {
                    ...
                    $file01_path     = "/var/www/html/admission/file4/";
                ...
                if ($file01_extension != "") {
                    ...
                    try{
                        ...
                        $sql_update = "UPDATE " . $_POST['m'] . " SET file_name_4 =  '" . $new_file01_name . "' WHERE  reg_card_id = '" . $_POST['student_id'] . "'";
                        //echo $sql_update;
