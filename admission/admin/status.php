...
$file_type2 = substr($str_file2, -3);
    ...
    if ($m == "1") {
        ...
        echo "
                <br>
                <form action='../admin/upload/image.php' method='post'>
        ...
        if ($str_file3 != "none") {
            ...
            <input type='hidden' name='student_tmp_name' value='$student_name'>
            <input type='hidden' name='student_m' value='$m'>
            <button class='btn btn-warning' type='submit'  >แก้ไขสำเนาทะเบียนบ้าน-</button>
            </form>
        ";
    }elseif ($m == "4"){
        echo '<hr>';
    ...
    echo "
                <br>
                <form action='upload/file4.php' method='post'>
                <input type='hidden' name='student_id' value='$student_id_card'>
                <input type='hidden' name='student_tmp_name' value='$student_name'>
                <input type='hidden' name='student_m' value='$m'>
    ...
    echo "
    <br>
    <form action='upload/file5.php' method='post'>
    <input type='hidden' name='student_id' value='$student_id_card'>
    <input type='hidden' name='student_tmp_name' value='$student_name'>
    <input type='hidden' name='student_m' value='$m'>
    <button class='btn btn-warning' type='submit'  >สำเนา ปพ.1 หน้าที่ 2</button>
    </form>
 ";
    //file 6
    echo '<hr>';
    ...
    echo "
                <br>
                <form action='upload/file6.php' method='post'>
                <input type='hidden' name='student_id' value='$student_id_card'>
                <input type='hidden' name='student_tmp_name' value='$student_name'>
                <input type='hidden' name='student_m' value='$m'>
                <button class='btn btn-warning' type='submit'  >แก้ไขผลการทดสอบระดับชาติ (O-NET)</button>
                </form>
             ";
    ?>
    </div>
