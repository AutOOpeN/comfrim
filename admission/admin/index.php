...
<div class="container">
  ...
  <div class="row btn-container">
            ...
            <div class="row mb-3">
              <div class="col-12">
                <a href="exam" class="btn " role="button" aria-pressed="true">
                  <div>
                    <div class="topic">ผู้มีสิทธิ์สอบ</div>
                    <div class="note"></div>
                  </div>
                </a>
              </div>
          ...
          <div class="col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="row mb-3">
              <div class="col-12">
                <a href="../registrationM1/student_list.php" class="btn green" role="button" aria-pressed="true">
                  <div>
            ...
            <div class="row mb-3">
              <div class="col-12">
                <a href="../registrationM4/student_list.php" class="btn pink" role="button" aria-pressed="true">
                  <div>
