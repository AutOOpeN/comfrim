...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="btn-group col-md-3" role="group">
                <a class="btn btn-info btn-lg"  href="ex_create_m1.php" role="button"><i class="fas fa-tasks"></i> สร้างผู้มีสิทธิสอบ </a>
            </div>
            <div class="btn-group col-md-3" role="group">       
    ...
    <div class="footer">
            <p>
			  	<i class='far fa-copyright'></i><?php echo (date('Y')+543) ?>
			  </p>
    </div>
