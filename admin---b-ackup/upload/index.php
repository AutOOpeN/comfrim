...
require_once '../../config/configAPP.inc.php';
...
<head>
    ...
    <script src="../../app/js/spk.js"></script>
</head>
...
<div class="container">
  <div class="row content">
    ...
    <div class="col-sm-10 text-left">
    	<h4 style="color:#043c96;text-shadow: 2px 2px 4px #000000;">อัพโหลดรูปภาพ</h4>
            <form class="form" method="post" action="">
            	<div class="form-group">
            		<label for="reg_card_id">เลขประจำตัวประชาชน: (#Ref. 1) </label>
                  	<input type="text" class="form-control" name="reg_card_id"  maxlength="13" onkeyup="keyup(this,event)" onkeypress="return Numbers(event)" required>
               	</div>
               	<div class="form-group">
                	<label for="mm">ระดับชั้นที่สมัคร: </label>
                	<select name="mm" class="custom-select" >
            			<option value="m1">ม.1 SMTE</option>
                        <option value="m1">ม.1 IP</option>
            			<option value="m4">ม.4 SMTE</option>
                        <option value="m4">ม.4 IP</option>
            		</select>
            	</div>
                <div class='form-group'>
				    <div class='custom-file'>
				    	<
				        <input type='file' class='custom-file-input' name='file6' id='customFile6' accept='image/jpeg' required>
				        <label class='custom-file-label' for='customFile6'>เลือกไฟล์รูปภาพ </label>
				    </div>
            	<div class="form-group">
                    <button class="btn btn-outline-primary btn-lg btn-block" type="submit" id="button-id"><i class="fas fa-file-upload"></i> ส่งไฟล์รูปภาพ</button>
            	</div>
