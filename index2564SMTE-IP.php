...
<body>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card text-center text-white bg-info">
                            ...
                            <div class="card-body">
                                <p class="card-text"><a href="pdf/M1_SMTE_IP.pdf" class="btn btn-secondary">คุณสมบัติผู้สมัคร</a></p>
                                <p class="card-text"><a href="app/m1_smte" class="btn btn-secondary" target="_blank">สมัคร โครงการ SMTE มัธยมศึกษาปีที่ 1 </a></p>
                                ...
                                <p class="card-text"><a href="app/m1_smte/student_list.php" class="btn btn-warning">พิมพ์บัตรประจำตัวสอบ โครงการ SMTE มัธยมศึกษาปีที่ 1
                                    </a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="card text-center text-white bg-info">
                            ...
                            <div class="card-body">
                                <p class="card-text"><a href="pdf/M4_SMTE_IP.pdf" class="btn btn-secondary">คุณสมบัติผู้สมัคร</a></p>
                                <p class="card-text"><a href="app/m4_smte" class="btn btn-secondary" target="_blank">สมัคร โครงการ SMTE มัธยมศึกษาปีที่ 4 </a></p>
                                <p class="card-text"><a href="app/m4_smte/student_list.php" class="btn btn-warning">พิมพ์บัตรประจำตัวสอบ โครงการ SMTE มัธยมศึกษาปีที่ 4
                                    </a></p>
                    ...
                    <div class="col-sm-6">
                        <div class="card text-center text-white bg-primary">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><a href="app/m1_ip/student_list.php" class="btn btn-warning">พิมพ์บัตรประจำตัวสอบ โครงการ IP มัธยมศึกษาปีที่ 1
                                    </a></p>
                    ...
                    <div class="col-sm-6">
                        <div class="card text-center text-white bg-primary">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><a href="app/m4_ip/student_list.php" class="btn btn-warning">พิมพ์บัตรประจำตัวสอบ โครงการ IP มัธยมศึกษาปีที่ 4
                                    </a></p>
    ...
    <div class="footer">
        <p><i class="far fa-copyright"></i> <a href="http://www.satreephuket.ac.th">โรงเรียนสตรีภูเก็ต </a> 1 ถนนดำรง
            ตำบลตลาดใหญ่ อำเภอเมือง จังหวัดภูเก็ต 83000 โทร 0 7622 2368 E-mail: <a href="mailto:stpk@satreephuket.ac.th">stpk@satreephuket.ac.th</a> </p>
    </div>
</body>
