    ...
    <div class="container">
        ...
        <div class="p-4">
            ...
            <div class="row">
                    ...
                    <!-- <div class="col-sm-4 p-2"><a href="#" class="btn btn-info">สมัครเข้าเรียน โครงการพิเศษ</a></div> -->
                    <div class="col-sm-8 p-2"><a href="admission" class="btn btn-primary">สมัครเข้าเรียน ห้องเรียนทั่วไป</a></div>
                    <div class="col-sm-2"></div>
        ...
        <div class="pt-4 pb-4">
        <img src="spkimg/contactus.jpg" class="responsive">
        </div>
