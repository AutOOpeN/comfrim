...
<body>
    <?php
        ...
        $sql_father = "UPDATE confirm_father SET 
            ...
            fOffice='". $_POST['fatherJobPlace']."',
            fIncome=". $_POST['fatherSalary'].",
            fTel='". $_POST['fatherTelNo'] ."'

            WHERE fStudent_id=". $_SESSION['ref1'] ; 
    ...
    try{
        ...
        echo $stmt_student->rowCount() . " records UPDATED successfully student<br>";  
        echo $stmt_mother->rowCount() . " records UPDATED successfully father<br>";  
        echo $stmt_mother->rowCount() . " records UPDATED successfully mother<br>";
        echo $stmt_parent->rowCount() . " records UPDATED successfully parent<br>";
