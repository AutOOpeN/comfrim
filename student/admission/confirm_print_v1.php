...
$pdf->Write(0, 'รหัสบ้าน ...'.$row['studentHomeIdNo'].'...  เลขที่ ...'.$row['studentHomeNo'].'... หมู่ที่ ...'.$row['studentMoo'].'...ซอย ...'.$row['studentSoi'].'...', '', 0, '', true, 0, false, false, 0);
$pdf->Write(0, 'ถนน ...'.$row['studentStreet'].'...ตำบล...'.$row['studentTumbol'].'...อำเภอ...'.$row['studentAmphur'].'...', '', 0, '', true, 0, false, false, 0);
$pdf->Write(0, 'จังหวัด...'.$row['studentProvince'].'...รหัสไปรษณีย์...'.$row['studentPostCode'].'...โทรศัพท์...'.$row['studentTelNo'].'...', '', 0, '', true, 0, false, false, 0);
$pdf->Write(0, 'ตามหลักฐานผลการเรียนและสำเนาทะเบียนบ้านดังแนบ', '', 0, '', true, 0, false, false, 0);
$pdf->SetXY($x+15,$y+230);
...
$y=0;
$html_page2_01  = <<<EOD
&nbsp; &nbsp; &nbsp; &nbsp;ข้าพเจ้าขอมอบตัว......................<i>$name</i>......................
EOD;

$html_page2_02 = <<<EOD
ให้เป็นนักเรียน และศึกษาเล่าเรียนในชั้นมัธยมศึกษาปีที่....<i>$m</i>.... ปีการศึกษา......<i>$y_edu</i>......ของโรงเรียนสตรีภูเก็ตตั้งแต่วันนี้เป็นต้นไป
EOD;

// output the HTML content
$pdf->SetFont('thsarabun', '', '14'); 
// $pdf->writeHTML($html_page2_01, true, false, true, false, '');
// $pdf->writeHTML($html_page2_02, true, false, true, false, '');
$pdf->SetXY($x+20,$y+15);
...
$pdf->SetXY($x+95,$y+100);
$pdf->Write(0,'(.......................................................................)','',0,'', true,0,false,false,0);
$pdf->SetXY($x,$y+260);
$pdf->Cell(0, 10, 'หน้า 2/2', 0, false, 'R', 0, '', 0, false, 'T', 'M');
