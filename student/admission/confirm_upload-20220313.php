...
<body>
    <div class="container">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <ul>
                        ...
                        <li>หลักฐานการสำเร็จการศึกษา ป.พ.1 (ให้นำส่งภายใน วันที่ 1 เมษายน 2565 ทางเว็บไซต์)</li>
                        <li>รูปถ่ายนักเรียนขนาด 1.5 นิ้ว เครื่องแบบนักเรียนโรงเรียนสตรีภูเก็ต (ให้นำส่งภายใน วันที่ 1 เมษายน 2565 ทางเว็บไซต์)</li>
                    </ul>
        ...
        <form action="" method="post" class="row g-3 pb-4 needs-validation" novalidate enctype="multipart/form-data">
                ...
                <div class="col-sm-12">
                    <input type="file" name="file01" class="form-control" accept="application/pdf" aria-label="file example" <?php if($row_file_check['confirm02_file01_status'] == 0 ){ echo "required";}?> >
                ...
                <div class="col-sm-12">
                    <input type="file" name="file02" class="form-control" accept="application/pdf" aria-label="file example" <?php if($row_file_check['confirm02_file02_status'] == 0 ){ echo "required";}?> >
                ...
                <div class="col-sm-12">
                    <input type="file" name="file03" class="form-control" accept="application/pdf" aria-label="file example" <?php if($row_file_check['confirm02_file03_status'] == 0 ){ echo "required";}?> >
                ...
                <div class="col-sm-12">
                    <input type="file" name="file04" class="form-control" accept="application/pdf" aria-label="file example" <?php if($row_file_check['confirm02_file04_status'] == 0 ){ echo "required";}?> >
                    <div class="invalid-feedback">สำเนาทะเบียนบ้านของ ผู้ปกครอง </div>
                </div>
                <hr>
                <div class="text-start ">
                    <span class="fw-bold">หลักฐานการสำเร็จการศึกษา ป.พ.1 (ให้นำส่งภายใน วันที่ 1 เมษายน 2565 ทางเว็บไซต์) <?php if($row_file_check['confirm02_file05_status'] != 0 ){ echo '<span class="text-success bg-warning">ส่งเอกสารแล้ว</span>';}?></span></span>
                </div>
                <div class="col-sm-12">
                    <input type="file" name="file05" class="form-control" accept="application/pdf" aria-label="file example" >
                    <div class="invalid-feedback">หลักฐานการสำเร็จการศึกษา ป.พ.1 (ให้นำส่งภายใน วันที่ 1 เมษายน 2565 ทางเว็บไซต์) </div>
                </div>
                <hr>
                <div class="text-start ">
                    <span class="fw-bold">รูปถ่ายนักเรียนขนาด 1.5 นิ้ว เครื่องแบบนักเรียนโรงเรียนสตรีภูเก็ต (ให้นำส่งภายใน วันที่ 1 เมษายน 2565 ทางเว็บไซต์)<?php if($row_file_check['confirm02_file06_status'] != 0 ){ echo '<span class="text-success bg-warning">ส่งเอกสารแล้ว</span>';}?></span> </span>
                </div>
                <div class="col-sm-12">
                    <input type="file" name="file06" class="form-control" accept="image/*" aria-label="file example" >
                    <div class="invalid-feedback">รูปถ่ายนักเรียนขนาด 1.5 นิ้ว เครื่องแบบนักเรียนโรงเรียนสตรีภูเก็ต (ให้นำส่งภายใน วันที่ 1 เมษายน 2565 ทางเว็บไซต์)</div>
                </div>
                <hr>
    ...
    if (isset($_FILES['file01'])) {
        ...
        if ($file01_extension != "") {
            ...
            $file01_path     = "/var/www/html/app/confirm/";
        ...
        if ($file02_extension != "") {
            ...
            $file2_path      = "/var/www/html/app/confirm/";
        ...
        if ($file03_extension != "") {
            ...
            $file3_path      = "/var/www/html/app/confirm/";
        ...
        if ($file04_extension != "") {
            ...
            $file4_path      = "/var/www/html/app/confirm/";
        ...
        if ($file05_extension != "") {
            ...
            $file5_path      = "/var/www/html/app/confirm/";
        ...
        if ($file06_extension != "") {
            ...
            $file6_path      = "/var/www/html/app/confirm/";
        ...
        if ($file06_extension != "") {
            ...
            $sql_update = "UPDATE " . $_SESSION['tbl_res'];
            $sql_update .= " SET confirm02_file01 = '" . $new_file01_name . "'";
            $sql_update .= ",confirm02_file02 = '" . $new_file02_name . "'";
            $sql_update .= ",confirm02_file03 = '" . $new_file03_name . "'";
            $sql_update .= ",confirm02_file04 = '" . $new_file04_name . "'";
            $sql_update .= ",confirm02_file05 = '" . $new_file05_name . "'";
            $sql_update .= ",confirm02_file06 = '" . $new_file06_name . "'";
            $sql_update .= ",confirm02_file01_status = '" . $file01_status . "'";
            $sql_update .= ",confirm02_file02_status = '" . $file02_status . "'";
            $sql_update .= ",confirm02_file03_status = '" . $file03_status . "'";
            $sql_update .= ",confirm02_file04_status = '" . $file04_status . "'";
            $sql_update .= ",confirm02_file05_status = '" . $file05_status . "'";
            $sql_update .= ",confirm02_file06_status = '" . $file06_status . "'";
            $sql_update .= " WHERE  ref1 = '" . $_SESSION['ref1'] . "'";
            $stmt = $conn->prepare($sql_update);
            $stmt->execute();
            echo "
                    <div class='alert alert-success text-center pt-4' role='alert'>
                       ส่งหลักฐานการมอบตัว  สำเร็จ <i class='bx bx-check-circle'></i>
                    </div>
                ";
            } catch (PDOException $e) { 
                echo "
