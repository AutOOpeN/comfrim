<?php
    ...
    switch ($plan){
        case 'm1': // m1-smte
            ...
            $sql_update_file = "UPDATE result_m1 SET $strFile = :fname WHERE ref1 = $id_card";
        ...
        case 'm4': // m4-smte
            ...
            $sql_update_file = "UPDATE result_m4 SET SET $strFile = :fname WHERE ref1 = $id_card";
...
<body>
    ...
    <?php
        if(isset($_POST['fileName'])){
            ...
            $stmt_upate_file = $conn->prepare($sql_update_file);
            $stmt_upate_file->execute(array(':fname' => $fname));
        }
    ...
    <form  class="row g-3" action="" method="post">
        ...
        <div class="col-6">
            <button type="submit" class="form-control btn btn-primary mb-3">เปลี่ยนสถานะ</button>
        </div>    
    </form>
    <hr>
    <form action="" method="post" class="row g-3 pb-4 needs-validation" novalidate enctype="multipart/form-data">
        <div class="text-start pt-4">
            <span class="fw-bold">เลือกไฟล์สำหรับแก้ไข  <?php echo $strHearder[$file_number - 1]?>  <i>(**กรณีแก้ไขไฟล์)</i></span>
        </div>
        <div class="col-sm-12">
            <input type="file" name="payment" class="form-control">
        </div>
        <div class="col-6">
            <button type="submit" class="form-control btn btn-primary mb-3">ส่งไฟล์</button>
        </div>
    </form>
    <hr>
    <div>
