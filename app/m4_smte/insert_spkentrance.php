...
$new_image_name = 'm4_smte_img_' . $_POST['xm1s003'] . "." . $img_extension;
...
$new_file02_name  = 'm4_smte_file_' . $_POST['xm1s003'] . "." . $file02_extension;
...
if ($file03_extension != "") {
    $new_file03_name = 'm4_smte_file_' . $_POST['xm1s003'] . "." . $file03_extension;
    ...
    ?>
        <div class="container">
            ...
            <form action="../bill/payment.php" method="post">
                ...
                <input type="hidden" name="plan" value="m4_smte">
