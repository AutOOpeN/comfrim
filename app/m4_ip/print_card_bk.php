...
$paln = "โครงการ IP (International Program)";
...
<table>
    ...
    <tr>
        <td width = "500" colspan="2"  style="text-align: center;"><h3>ชั้นมัธยมศึกษาปีที่ 4 ปีการศึกษา 2563</h3></td>
    </tr>
</table>
...
EOD;
$str_comment = <<<EOD
(นำส่วนนี้มาแสดงในวันสอบ ถ้าไม่มีจะไม่อนุญาตให้เข้าสอบ)* <u>สอบวันที่ 8 มีนาคม 2563</u> กรุณานำ <u>ดินสอดำ 2B</u> มาใช้ในการสอบ
EOD;
