...
?>
    <div class="container">
        ...
        <form class="needs-validation" method="post" enctype="multipart/form-data" action="insert_spkentrance.php" novalidate>
            ...
            <fieldset class="myfieldset">
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="invalid-feedback">หมายเหตุ : </div>
                    </div>
                    <div class="col-md-4 mb-3">
            ...
            <fieldset class="myfieldset">
                <legend class="myfieldset">สมัครโครงการ IP </legend>
                (ผู้สมัครเลือกแผนการเรียนที่ต้องการเพียง 1 แผน) *
                <div class="custom-control custom-radio mb-3">
                    <input class="custom-control-input" type="radio" name="xm1s290" value="2" id="radio2902" required>
                    <label class="custom-control-label" for="radio2902"> IP แผนการเรียน ภาษาอังกฤษ - คณิตศาสตร์ ( *ข้อสอบเป็นภาษาอังกฤษเท่านั้น )</label>
                </div>
                <!-- <div class="custom-control custom-radio mb-3">
                    <input class="custom-control-input" type="radio" name="xm1s290" value="3" id="radio2903" required>
                    <label class="custom-control-label" for="radio2903"> IP แผนการเรียน วิทยาศาสตร์ - คณิตศาสตร์ ( *ข้อสอบเป็นภาษาอังกฤษเท่านั้น )</label>
                </div> -->
                <div class="custom-control custom-radio mb-3">
                    <input class="custom-control-input" type="radio" name="xm1s290" value="4" id="radio2904" required>
                    <label class="custom-control-label" for="radio2904"> IPC แผนการเรียน Cambridge ( *ข้อสอบเป็นภาษาอังกฤษเท่านั้น )</label>
                </div>
                ...
                <div class="custom-control custom-radio mb-3">
                    <input class="custom-control-input" type="radio" name="xm1s330" id="xm1s3302" value="eng" required checked>
                    <label class="custom-control-label" for="xm1s3302"> ภาษาอังกฤษ </label>
                </div>
            </fieldset>

            <fieldset class="myfieldset">
                <legend class="myfieldset">หลักฐานการสมัคร </legend>
