...
?>
                ...
                <fieldset class="myfieldset">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="customFile2">  หนังสือรับรองผลการเรียนวิชาวิทยาศาสตร์และคณิตศาสตร์ หรือ ปพ. 1 (โครงการ SMTE) </label>
                    </div>
                </fieldset>
        ...
        <footer class="footer">
            <div class="container">
                <p><i class="far fa-copyright"></i> <a href="http://www.satreephuket.ac.th">โรงเรียนสตรีภูเก็ต </a> 1 ถนนดำรง ตำบลตลาดใหญ อำเภอเมือง จังหวัดภูเก็ต 83000  โทร 076-222368 </p>
                <p></p>
            </div>
      </footer>
    </div>
