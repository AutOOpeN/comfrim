...
try {
    ...
    , m1s310 , m1s320 , m1s330, file_name_1, file_name_2 )
    ...
    , '" . $_POST['xm1s260'] . "','" . $am_3[1] . "','" . $am_3[0] . "','" . $prov_3[1] . "','" . $prov_3[0] . "','" . $_POST['xm1s290'] . "','" . $_POST['xm1s300'] . "'
    , '" . $_POST['xm1s310'] . "','" . $_POST['xm1s320'] . "','" . $_POST['xm1s330'] . "', '" . $upload_path . "','" . $upload_path02 . "')";
...
//file02
    ...
    ?>
            <form action="bill/payment.php" method="post">
                ...
                <button class="btn btn-primary" type="submit"><i class="fas fa-print"></i> พิมพ์ใบสมัคร</button>
            </form>
