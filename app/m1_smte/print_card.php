...
$str_sql = "SELECT * FROM ex_m1_s WHERE ref1 = '" . $ref1 . "'";
...
<table>
    <tr>
        ...
        <td width = "500" colspan="2" style="text-align: right;"><h2><b>เลขประจำตัวสอบ: <u> $exam_id </u></b><br /> ห้องสอบ: <u> $exam_room </u></h2></td>
    </tr>
    <tr>
