...
<head>
    <title>ระบบรับนักเรียน ม. 1 โครงการพิเศษ <?php echo $strEducationYear; ?></title>
    <meta charset="utf-8">
...
<body>
    <div class=" text-center">
        ...
        <div class="container">
            <p></p>
            <h1 class="jumbotron-heading"> <?php echo $strTitle; echo $strEducationYear ?> </h1>
            <h4> โรงเรียนสตรีภูเก็ต </h4>
            <hr>
            <p class="lead text-muted"><?php echo $strTitleSMTE_M1 ?></p>
...
?>
    <div class="container">
        ...
        <form class="needs-validation" method="post" enctype="multipart/form-data" action="insert_spkentrance.php"
            novalidate>
            ...
            <fieldset class="myfieldset">
                ...
                <div class="form-row">
                    <div class="col-md4 mb-3">
                        ...
                        <select id="myOption" class="custom-select" onchange="setValue(this,'xm1s010','xm1s011')"
                            required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input id="xm1s020" type="text" class="form-control " name="xm1s020" size="35"
                            placeholder="ชื่อผู้สมัคร *" required>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="xm1s030">นามสกุล: </label>
                        <input type="text" class="form-control " name="xm1s030" size="35"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control " name="xm1s003" maxlength="13"
                        placeholder="เลขบัตรประชาชน *" onkeyup="keyup(this,event)" onkeypress="return Numbers(event)"
                        required>


                    <label for="xm1s004">เลขหนังสือเดินทาง: </label>
                    <input type="text" class="form-control " name="xm1s004" size="15" maxlength="13"
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select id="myOptionDD" name="myOptionDD" class="custom-select"
                            onchange="setValueDD(this,'xm1s040dd','xm1s041dd')" required>
...
?>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select id="myOptionMM" name="myOptionMM" class="custom-select"
                            onchange="setValueMM(this,'xm1s040mm','xm1s041mm')" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select id="myOptionYY" name="myOptionYY" class="custom-select"
                            onchange="setValueYY(this,'xm1s040yy','xm1s041yy')" required>
...
?>
            ...
            <fieldset class="myfieldset">
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="xm1s050" size="15" placeholder="เลขที่ *"
                            required>
                    </div>
                    <div class="col-md-4 mb-3">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="xm1s110" size="12" class="form-control" onkeyup="autoTab(this)"
            ...
            <fieldset class="myfieldset">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="xm1s150" size="35" class="form-control" onkeyup="autoTab(this)"
                            onkeypress="return Numbers(event)" required>
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset class="myfieldset">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="xm1s200" size="35" class="form-control" onkeyup="autoTab(this)"
                            onkeypress="return Numbers(event)" required>
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset class="myfieldset">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="xm1s250" size="35" class="form-control" onkeyup="autoTab(this)"
                            onkeypress="return Numbers(event)" required>
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset class="myfieldset">
                <legend class="myfieldset">สมัครโครงการ SMTE </legend>
                <div class="custom-control custom-radio mb-3">
                    <input class="custom-control-input" type="radio" name="xm1s290" id="radio2901" value="1" required>
                    <label class="custom-control-label" for="radio2901"> SMTE ผลการเรียนเฉลี่ยชั้นประถมศึกษาปีที่ 4 และ
                        5 ดังนี้
                    </label>
                </div>
                โครงการ:
                <div class="form-row">
                    <div clall="col-md-4 mb-3">
                        <label for="xm1s300">วิชาคณิตศาสตร์พื้นฐาน</label> <input type="text" name="xm1s300"
                            id="xm1s300" class="form-control" required
                            onkeypress="return event.charCode >= 46 && event.charCode <= 57" maxlength="4">
                        <label for="xm1s310">วิทยาศาสตร์พื้นฐาน </label> <input type="text" name="xm1s310" id="xm1s310"
                            class="form-control" required required
                            onkeypress="return event.charCode >= 46 && event.charCode <= 57" maxlength="4">
                        <label for="xm1s320">ผลการเรียนเฉลี่ยรวม </label> <input type="text" name="xm1s320" id="xm1s310"
                            class="form-control" required required
                            onkeypress="return event.charCode >= 46 && event.charCode <= 57" maxlength="4">
                    </div>
                </div>
            ...
            <fieldset class="myfieldset">
                ...
                <div class="custom-file">
                    <input type="file" class="custom-file-input" name="file1" id="customFile1" accept="image/jpeg"
                        required>
                    <label class="custom-file-label" for="customFile1"> รูปถ่ายขนาด 1 นิ้ว [ ประเภทไฟล์ JPEG (*.jpg,*.jpeg,*.jpe,*.jfif) ]</label>
                </div>
                <div class="custom-file">
                    <input type="file" class="custom-file-input" name="file2" id="customFile2"
                        accept="application/pdf, image/*" required>
                    <label class="custom-file-label" for="customFile2">
                        สำเนาหนังสือรับรองผลการเรียนวิชาวิทยาศาสตร์และคณิตศาสตร์ หรือ ปพ. 1 (โครงการ SMTE)
                        พร้อมเซ็นรับรองสำเนาถูกต้องทุกหน้า </label>
                </div>
                <div class="custom-file">
                    <input type="file" class="custom-file-input" name="file3" id="customFile3"
                        accept="application/pdf, image/*">
                    <label class="custom-file-label"
                        for="customFile3">สำเนาหนังสือรับรองผลการเรียนวิชาวิทยาศาสตร์และคณิตศาสตร์ หรือ ปพ. 1 (โครงการ
                        SMTE) *ถ้ามี </label>
                </div>
            </fieldset>
            <fieldset class="myfieldset">
    ...
    <footer class="footer">
        <div class="container">
            <p><i class="far fa-copyright"></i> <a href="http://www.satreephuket.ac.th">โรงเรียนสตรีภูเก็ต </a> 1
                ถนนดำรง ตำบลตลาดใหญ่ อำเภอเมือง จังหวัดภูเก็ต 83000 โทร 076-222368 </p>
            <p></p>
        </div>
    </footer>
    </div>
