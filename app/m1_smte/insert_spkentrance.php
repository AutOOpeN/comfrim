...
<html lang="en">
    <head>
        <title>ระบบรับนักเรียน ม. 1 โครงการพิเศษ SMTE <?php echo $strEducatonYear ?></title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <img src="../../../spkimg/head1.gif" class ="img-fluid pull-center">
            <div class="container">
                ...
                <p class="lead text-muted">ชั้นมัธยมศึกษาปีที่ 1 <?php echo $strEducatonYear ?></p>
                <hr>
            </div>
        </div>
...
$new_image_name = 'm1_smte_img_' . $_POST['xm1s003'] . "." . $img_extension;
...
$new_file02_name  = 'm1_smte_file_' . $_POST['xm1s003'] . "." . $file02_extension;
...
if ($file03_extension != "") {
    $new_file03_name = 'm1_smte_file_' . $_POST['xm1s003'] . "." . $file03_extension;
