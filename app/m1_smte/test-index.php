    ...
    <body>
        ...
        <img src="../../spkimg/head1.gif" class ="img-fluid pull-center">
            ...
            <p></p>
                ...
                <hr>
                <p class="lead text-muted">ใบสมัครเข้าศึกษาโครงการห้องเรียนพิเศษ โรงเรียนสตรีภูเก็ต </p>
                <p class="lead text-muted">ชั้นมัธยมศึกษาปีที่ 1 ปีการศึกษา 2562</p>
                <h1 class="jumbotron-heading">ห้องเรียนพิเศษ โครงการ SMTE </h1>
                <hr>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <form class="needs-validation" method="post" enctype="multipart/form-data" action="test-insert.php"  novalidate>
...
?>
                ...
                <fieldset class="myfieldset">
                    ...
                    <div class="custom-control custom-radio mb-3">
                        ...
                        <label class="custom-control-label" for="radio2901"> SMTE ผลการเรียนเฉลี่ยชั้นประถมศึกษาปีที่ 4 และ 5 ดังนี้
                        </label>
                    </div>
                    โครงการ:
                    <div class="form-row">
                ...
                <fieldset class="myfieldset">
                    <legend class="myfieldset">หลักฐานการสมัคร (เอกสาร Upload) เอกสารต้องใช้เครื่อง Scanner เท่านั้น</legend>
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" name="file1" id="customFile1" accept="image/*" required>
                        <label class="custom-file-label" for="customFile1"> รูปถ่าย </label>
                    </div>
                    <div class="custom-file">
