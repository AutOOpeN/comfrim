...
<body>
    ...
    <div class="container ">
        ...
        <ul class="nav nav-pills nav-fill">
            ...
            <li class="nav-item">
                <a class="nav-link " href="m4_smte.php">ม. 4 SMTE</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="m4_ip.php">ม. 4 IP</a>
            </li>
        </ul>
        <hr>
        <div class="btn-group col-md-4" role="group">
            <a class="btn btn-success btn-sm" href="m4_ip_excel.php" role="button"><i class="far fa-file-excel"></i> นำข้อมูลออกไฟล์ Excel </a>
        </div>
        <br />
        <?php
...
*/
        ...
        <div class="btn-group col-md-4 pb-4" role="group">       
                <a class="btn btn-success btn-sm"  href="m4_ip_cam_excel.php" role="button"><i class="far fa-file-excel"></i>  นำข้อมูลออกไฟล์ Excel  </a>
        </div>    
