        ...
        <div>
            ...
            <form  action="" method="post" enctype="multipart/form-data">
                ...
                <fieldset class="myfieldset">
                    <legend class="myfieldset">หลักฐานการจ่ายเงิน </legend>
                
                    <div class="custom-file">
                        <input type="file" name="file3" id="file3-upload" class="custom-file-input" >
                        <label class="custom-file-label" for="file3">หลักฐานการจ่ายเงิน	</label>                 
                    </div>
        ...
        <?php
            ...
            if ( isset ($_FILES['file3'])){
                ...
                if ($file01_extension != "") {
                    ...
                    $file01_path     = "/var/www/html/admission/file7/";
                ...
                if ($file01_extension != "") {
                    ...
                    if ($status_file3 == false) {
                        echo "ไม่สามารถส่งไฟล์ หลักฐานการจ่ายเงิน	";
                        //exit();
                    }
                    try{
                        $conn = new PDO("mysql:host=$servername;dbname=$dbname;charset=utf8", $username, $password);
                        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                        $sql_update = "UPDATE " . $_POST['m'] . " SET file_name_7 =  '" . $new_file01_name . "' WHERE  reg_card_id = '" . $_POST['student_id'] . "'";
                        //echo $sql_update;
