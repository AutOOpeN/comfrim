        ...
        <div>
            ...
            <form  action="" method="post" enctype="multipart/form-data">
                ...
                <div class="custom-file">
                    ...
                    <label class="form-label" for="file1">เลือกรูปถ่าย</label>
                    <input type="file" name="file1" id="file-upload" class="form-control" >
        ...
        <?php
            ...
            if ( isset ($_FILES['file1'])){
                ...
                if ($file01_extension != "") {
                    ...
                    $file01_path     = "/var/www/html/app/file1/";
                ...
                if ($file01_extension != "") {
                    ...
                    try{
                        ...
                        $sql_update = "UPDATE " . $_POST['tbl'] . " SET file_name_1 =  '" . $new_file01_name . "' WHERE  m1s003 = '" . $_POST['student_id'] . "'";
                        //echo $sql_update;
                ...
                // echo $upload_path01;
                // echo "<img src='../../file1/" . $new_file01_name ."' >";
                // echo "";
        ?>
