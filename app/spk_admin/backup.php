<?php
$connect = new PDO("mysql:host=localhost;dbname=SpkEntrance", "root", ",uok8,");
    ...
    <div class="container">
        <div class="row">
            ...
            <form method="post" id="export_form">
                ...
                ?>
                    <div class="checkbox">
                        <label><input type="checkbox" class="checkbox_table" name="table[]" value="<?php echo $table["Tables_in_SpkEntrance"]; ?>" /> <?php echo $table["Tables_in_SpkEntrance"]; ?></label>
                    </div>
                <?php
                }
                ?>
