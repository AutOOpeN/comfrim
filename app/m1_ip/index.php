            ...
            <form class="needs-validation" method="post" enctype="multipart/form-data" action="insert_spkentrance.php"  novalidate>
                ...
                <fieldset class="myfieldset">
                    ...
                    <div class="custom-control custom-radio mb-3">
                        <input class="custom-control-input" type="radio" name="xm1s290" value="2" id="radio2902"   onchange="chooseExam()" required>
                    ...
                    -->
                    <div class="custom-control custom-radio mb-3">
                        <input class="custom-control-input" type="radio"  name="xm1s290" value="4" id="radio2904" onchange="chooseExam()" required>
                        <label class="custom-control-label" for="radio2904"> IPC แผนการเรียน Cambridge   </label>
                    </div>
