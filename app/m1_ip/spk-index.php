...
<html lang="en">
    ...
    <body>
        ...
        <img src="../../spkimg/head1.gif" class ="img-fluid pull-center">
            <div class="container">
                <p></p>
            <h1 class="jumbotron-heading">ระบบรับนักเรียนปีการศึกษา <?php echo $strEducationYear ?> </h1>
 ...
 ?>
    <!-- <div class="container">
       <div class="alert alert-primary" role="alert">
         ...
         <?php //include_once('../../spk/schedule.html') ?>
       </div>
    </div>
    <hr>
        <footer class="footer">
...
?>
                ...
                <fieldset class="myfieldset">
                    ...
                    <div class="custom-control custom-radio mb-3">
                        ...
                        <label class="custom-control-label" for="radio2902"> IP (International Program)</label>
                    </div>
                    <!--
                    <div class="custom-control custom-radio mb-3">
