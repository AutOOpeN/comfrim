...
<body>
    ...
    <div class="container">
        ...
        $new_image_name = 'm1_ip_img_' . $_POST['xm1s003'] . "." . $img_extension;
        ...
        $new_file02_name  = 'm1_ip_file_' . $_POST['xm1s003'] . "." . $file02_extension;
        ...
        if ($file03_extension != "") {
            $new_file03_name = 'm1_ip_file_' . $_POST['xm1s003'] . "." . $file03_extension;
