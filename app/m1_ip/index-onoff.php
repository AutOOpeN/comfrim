...
<html lang="en">
    <head>
        <title>ระบบรับนักเรียน ม. 1 โครงการพิเศษ IP ปีการศึกษา 2563</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <img src="../../spkimg/head1.gif" class ="img-fluid pull-center">
            ...
            <hr>
                <p class="lead text-muted">ใบสมัครเข้าศึกษาโครงการ IP (international Program) </p>
                <p class="lead text-muted">ชั้นมัธยมศึกษาปีที่ 1 ปีการศึกษา 2563</p>
 ...
 ?>
    <div class="container">
       <div class="alert alert-primary" role="alert">
         <h4 class="alert-heading">ปิดรับสมัคร</h4>
         <p></p>
         <p class="mb-0">กำหนดการรับสมัครประจำปี 2563</p>
         <table class="table table-bordered table-hover text-center">
            <thead>
                <tr class="table-primary">
                    <th scope="col">ระดับชั้น</th>
                    <th scope="col">รับสมัคร</th>
                    <th scope="col">สอบคัดเลือก</th>
                    <th scope="col">ประกาศผล</th>
                    <th scope="col">รายงานตัว</th>
                    <th scope="col">มอบตัว</th>                    
                </tr>
            </thead>
            <tbody>
                <tr class="table-primary">
                    <td colspan="6">ชั้นมัธยมศึกษาปีที่ 1</td>
                </tr>
                <tr class="table-primary">
                    <td class="text-left"scope="row">-SMTE<br/>-IP และ IPC</td>
                    <td>22-26 ก.พ. 63</td>
                    <td>7 มี.ค. 63</td>
                    <td>11 มี.ค. 63</td>
                    <td>13 มี.ค. 63 (เช้า)</td>
                    <td>17 มี.ค. 63</td>
                </tr>
                <tr class="table-primary">
                    <td colspan="6">ชั้นมัธยมศึกษาปีที่ 4</td>
                </tr>
                <tr class="table-primary">
                    <td class="text-left" scope="row">-SMTE<br/>-IP และ IPC</td>
                    <td>22-26 ก.พ. 63</td>
...
?>
                ...
                <fieldset class="myfieldset">
                    <legend class="myfieldset">สมัครโครงการ IP (ผู้สมัครเลือกแผนการเรียนที่ต้องการเพียง 1 แผน) * </legend>
                    <div class="custom-control custom-radio mb-3">
                        <input class="custom-control-input" type="radio" name="xm1s290" value="2" id="radio2902"required>
                        <label class="custom-control-label" for="radio2902"> IP แผนการเรียน ภาษาอังกฤษ - คณิตศาสตร์</label>
                    </div>
                    <!--
                    <div class="custom-control custom-radio mb-3">
                        <input class="custom-control-input" type="hide"  name="xm1s290" value="3" id="radio2903" required>
                        <label class="custom-control-label" for="radio2903"> IP แผนการเรียน วิทยาศาสตร์ - คณิตศาสตร์</label>
                    </div>
                    -->
                    <div class="custom-control custom-radio mb-3">
                        <input class="custom-control-input" type="radio"  name="xm1s290" value="4" id="radio2904" required>
                        <label class="custom-control-label" for="radio2904"> IPC แผนการเรียน Cambridge  ( *เลือกข้อสอบเป็นภาษาอังกฤษเท่านั้น )</label>
                    </div>
                    ผู้สมัครโครงการ IP เลือกข้อสอบ * :
                    <div class="custom-control custom-radio mb-3">
                        <input class="custom-control-input" type="radio" name="xm1s330" id="xm1s3301" value="th" required>
                        <label class="custom-control-label" for="xm1s3301">  ภาษาไทย </label>
                    </div>
                    <div class="custom-control custom-radio mb-3">
                        <input class="custom-control-input" type="radio" name="xm1s330" id ="xm1s3302" value="eng" required>
                        <label class="custom-control-label" for="xm1s3302">  ภาษาอังกฤษ </label>
                    </div>
                ...
                <fieldset class="myfieldset">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="customFile2">สำเนาเอกสารแสดงความเป็นนักเรียน (โครงการ IP) พร้อมเซ็นรับรองสำเนาถูกต้องทุกหน้า </label>
                    </div>
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" name="file3" id="customFile3" accept="application/pdf, image/*" >
                        <label class="custom-file-label" for="customFile3">สำเนาเอกสารแสดงความเป็นนักเรียน (โครงการ IP) *ถ้ามี   </label>
                    </div>
                </fieldset>
