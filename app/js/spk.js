        ...
        var validation = Array.prototype.filter.call(forms, function(form) {
            form.addEventListener('submit', function(event) {
                if (form.checkValidity() === false) {
                    ...
                    alert("กรุณากรอกข้อมูลให้ครบ (ช่องที่มีกรอบสีแดง) และ ยอมรับเงื่อนไขการสมัครด้านล่าง");
                }
...
function chooseExam() {
    ...
    var ipc = document.getElementById("radio2904").checked;
    var ip = document.getElementById("radio2902").checked;
    if (ipc == true) {
        document.getElementById("xm1s3301").disabled = true;
        document.getElementById("xm1s3301").checked = false;
        document.getElementById("xm1s3302").disabled = false;
        document.getElementById("xm1s3302").checked = true;
    } else if (ip = true) {
        document.getElementById("xm1s3301").disabled = false;
        document.getElementById("xm1s3302").disabled = false;
        document.getElementById("xm1s3301").checked = false;
        document.getElementById("xm1s3302").checked = false;
    }
}