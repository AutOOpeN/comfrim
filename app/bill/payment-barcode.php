...
try {
    switch ($plan_tmp) {
        case 'm1_smte':
            ...
            $plan_select = "ค่าสมัครสอบ <br>เข้าศึกษาโครงการห้องเรียนพิเศษ SMTE ชั้นมัธยมศึกษาปีที่ 1 ปีการศึกษา 2563";
            break;
        case 'm1_ip':
            $str_sql     = "SELECT * FROM m1_ip WHERE m1s003 = '" . $_POST['id_card'] . "'";
            $plan_select = "ค่าสมัครสอบ <br>เข้าศึกษาโครงการห้องเรียนพิเศษ IP ชั้นมัธยมศึกษาปีที่ 1 ปีการศึกษา 2563";
            break;
        case 'm4_smte':
            $str_sql     = "SELECT * FROM m4_s WHERE m1s003 =  '" . $_POST['id_card'] . "'";
            $plan_select = "ค่าสมัครสอบ <br>เข้าศึกษาโครงการห้องเรียนพิเศษ SMTE ชั้นมัธยมศึกษาปีที่ 4 ปีการศึกษา 2563";
            break;
        case 'm4_ip':
            $str_sql     = "SELECT * FROM m4_ip WHERE m1s003 =  '" . $_POST['id_card'] . "'";
            $plan_select = "ค่าสมัครสอบ <br>เข้าศึกษาโครงการห้องเรียนพิเศษ IP ชั้นมัธยมศึกษาปีที่ 4 ปีการศึกษา 2563";
            break;
        default:
            $str_sql     = "";
            $plan_select = "ค่าสมัครสอบ <br>เข้าศึกษาโครงการห้องเรียนพิเศษ ปีการศึกษา 2563";
            break;
    }
    //$str_sql = "SELECT * FROM m4_ip where m1s003 =  '" . $_POST['id_card'] . "'";
...
<table>
<tr>
<td  style="text-align: right;"><img src="../../images/logo_bank.jpg" width="70" height="70"> </td>
...
//echo $barcode_ref1->getBarcodeHTML(2, 30, 'black');
$code1="1234569";
$barcodeobj = new TCPDFBarcode('12354', 'C128');
...
$pdf->Ln(10);
$pdf->writeHTMLCell(0, 0, '', '', "หมายเหตุ : สามารถนำไปชำระเงิน ที่ธนาคารกรุงไทยทุกสาขา ตั้งแต่วันที่ 22 ถึง (<u>27 กุมภาพันธ์ พ.ศ. 2563 ก่อน 16.30น.</u>) เท่านั้น", 0, 1, 0, true, '', true);
$pdf->Ln(10);
